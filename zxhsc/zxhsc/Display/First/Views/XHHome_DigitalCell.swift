...
class XHHome_DigitalCell: UITableViewCell {
    ...
    fileprivate let reuseId_collection = "XHHome_DigitalCell_reuseId_collection"
    ...
    private func setupCollectionView() {
        ...
        collectionView.snp.remakeConstraints { (make) in
            make.left.equalTo(bigView.snp.right)
    ...
    private var layout: UICollectionViewFlowLayout = {
        ...
        layout.sectionInset = UIEdgeInsetsMake(14, 4, 14, 14)
        return layout
    }()
...
extension XHHome_DigitalCell: UICollectionViewDelegate, UICollectionViewDataSource {
    // 几个格子
