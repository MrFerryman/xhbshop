...
/**
 按钮中图片的宽
 */
@property(nonatomic,assign)CGFloat  tagButtonImageW;

/**
 按钮中图片的高
 */
@property(nonatomic,assign)CGFloat  tagbuttonImageH;
/**
 按钮中的上下边距
 */
@property(nonatomic,assign)CGFloat tagButtonMarginHeight;
/**
 按钮数组
 */
...
/**
 首行最宽宽度
 */
@property(nonatomic,assign)CGFloat  FirstRowWidth;
/**
 *  标签删除图片
 */
...
/**
 选中后的图片
 */
@property(nonatomic,strong)UIImage *tagSelectedimage;
/**
 *  标签间距,和距离左，上间距,默认10
 */
